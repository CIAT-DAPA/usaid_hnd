...
setwd("W:/00_scripts/Interpolations")
anuDir <- "D:/cenavarro/hnd_usaid/04_interpolation/anu/Anuspl43/bin"
stDir <- "D:/cenavarro/hnd_usaid/04_interpolation/stations-averages/climatology_v2"
rDir <- "D:/cenavarro/hnd_usaid/04_interpolation/region/v3"
oDir <- "D:/cenavarro/hnd_usaid/04_interpolation/outputs_climatology_v2/tmax"
