...
# Set params
bDir <- "D:/cenavarro/hnd_usaid/04_interpolation/outputs_yearly_v2/average/tif"
...
for (yr in years){
  ...
  for (var in varList){
    ...
    tiff(paste(oDir, "/plot_monthly_", var, "_", yr, ".tif", sep=""), width=1000, height=1200, pointsize=8, compression='lzw',res=100)
