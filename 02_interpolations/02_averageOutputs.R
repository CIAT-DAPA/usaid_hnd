...
iDir <- "D:/cenavarro/hnd_usaid/04_interpolation/outputs_climatology_v2"
oDir <- "D:/cenavarro/hnd_usaid/04_interpolation/outputs_climatology_v2/average"
...
iDir <- "D:/cenavarro/hnd_usaid/04_interpolation/outputs_climatology_v2/average"
oDir <- iDir
