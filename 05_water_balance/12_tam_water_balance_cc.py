...
scenario = "rcp2.6_2030"  # Change this for the scenario to be run
shared_dir = os.path.join(in_dir, "climate_change", "downscaled_ensemble", scenario)
...
for year in years_execution:
    ...
    precip_dir = os.path.join(shared_dir, weather_vars['precipitation'], str(year))
    eto_dir = os.path.join(shared_dir, weather_vars['potential_evap'], str(year))
