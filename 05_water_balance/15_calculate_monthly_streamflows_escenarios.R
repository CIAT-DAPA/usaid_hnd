...
wyield = read.csv(paste0(net_drive, "/06_analysis/Scenarios/", scenario ,"/mth_avg_timeline_microusos_wyield.csv"))
oDir <- paste0(net_drive, "/06_analysis/Scenarios/", scenario)
mask <- paste0(net_drive, "/06_analysis/Scenarios/masks/Microcuencas_ZOI_Usos4_Finales.shp")
