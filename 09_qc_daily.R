...
outDir = "X:/Water_Planning_System/01_weather_stations/hnd_all/daily_processed/"
...
if( variable=="tmin"){
  minim = 5 ;maxim = 35; ric = 7; criterio1=15
...
if(variable=="prec"){
  ...
  }, error=function(e){cat("ERROR :",name_st[i],conditionMessage(e), "\n")})
  }
