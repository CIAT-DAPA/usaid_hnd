...
if len(sys.argv) < 5:
	os.system('cls')
	print "\n Too few args"
	print "   - ie: python 00_LatLonRaster_v2.py S:\observed\gridded_products\srtm\Altitude_30s\alt D:\cenavarro\hnd_usaid\region\v3 hnd 1"
	sys.exit(1)
...
if not arcpy.Exists(OutAlt):
	arcpy.Clip_management(dem, "-89.5 12.5 -85.5 16.5", OutAlt)
