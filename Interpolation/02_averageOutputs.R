...
iDir <- "D:/cenavarro/hnd_usaid/04_interpolation/outputs_climatology"
oDir <- "D:/cenavarro/hnd_usaid/04_interpolation/outputs_climatology/average"
...
iDir <- "D:/cenavarro/hnd_usaid/04_interpolation/outputs_climatology/average"
oDir <- iDir
