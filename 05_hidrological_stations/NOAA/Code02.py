...
print ("\n*** Ejecutandose Proceso Descarga Informacion Diaria NOAA... ***\n");

StartDate = str(datetime.now() - timedelta(days=1)).split(' ')[0]
DirResult = 'Output\\' + StartDate
if not os.path.exists(DirResult): 
	os.makedirs(DirResult)

currURL = 'https://hads.ncep.noaa.gov/nexhads2/servlet/DecodedData?sinceday=1&hsa=nil&state=HN&nesdis_ids=nil&of=1'
