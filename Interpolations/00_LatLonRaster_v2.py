...
if len(sys.argv) < 5:
	os.system('cls')
	print "\n Too few args"
	print "   - ie: python 00_LatLonRaster_v2.py S:\observed\gridded_products\srtm\SRTM_v41_30s\srtm_v41_30s W:\04_interpolation\region hnd 1"
	sys.exit(1)
...
if not arcpy.Exists(OutAlt):
	arcpy.Clip_management(dem, "-90 13 -83 16", OutAlt)
