...
oDir <- "D:/col-usaid/02-monthly-interpolations/performance_new_region"
years <- 1981:2010
...
geotopo <- readOGR("D:/col-usaid/02-monthly-interpolations/region/mask/ecotopo_prj.shp", layer= "ecotopo_prj")
