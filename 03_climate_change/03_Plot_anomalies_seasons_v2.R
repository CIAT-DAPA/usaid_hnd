  ...
  baseDir <- "D:/OneDrive - CGIAR/CIAT/Projects/hnd-pnud-ciat-escenarios/04_Escenarios/anomalies_ens_v2"
  perList <- c("2020_2049", "2040_2069", "2070_2099")
  perListMod <- c("2030s", "2050s", "2080s")
  varList <- c("tmin", "tmax", "tmean", "prec", "dtr")
  # varList <- c("tmean", "dtr")
  ...
  oDir <- "D:/OneDrive - CGIAR/CIAT/Projects/hnd-pnud-ciat-escenarios/04_Escenarios/evaluation"
