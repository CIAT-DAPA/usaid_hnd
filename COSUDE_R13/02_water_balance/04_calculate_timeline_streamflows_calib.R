...
wyield = read.csv(paste0(net_drive, "/06_analysis/Calibration/", scenario, "/mth_yearly_timeline_wyield.csv"))
oDir <- paste0(net_drive, "/06_analysis/Calibration/", scenario)
mask <- paste0(net_drive, "/06_analysis/Calibration/mask/Cuencas_Calibracion_Caudal.shp")
yi <- "2000"
yf <- "2014"
years = yi:yf
months = 1:12
